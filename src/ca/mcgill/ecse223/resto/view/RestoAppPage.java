	...
	private void initComponents() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup()
				...
				.addGroup(layout.createSequentialGroup()
						...
						.addGroup(layout.createParallelGroup().addComponent(menuButton)
		...
		layout.setVerticalGroup(layout.createParallelGroup()
				.addGroup(layout.createSequentialGroup().addComponent(errorMessage)
						...
						.addGroup(layout.createParallelGroup().addComponent(widthLabel).addComponent(widthTextField)
								.addComponent(removeTableButton).addComponent(addTableOrSeatButton))
		...
		if (selectedTableIndex < 0) {
			...
			try {
				RestoAppController.reserveTable(null, null, Integer.parseInt(numberInPartyTextField.getText()),
						contactNameTextField.getText(), contactEmailAddressTextField.getText(),
						contactPhoneNumberTextField.getText(), null, selectedTableNumber);
			} catch (InvalidInputException e) {
